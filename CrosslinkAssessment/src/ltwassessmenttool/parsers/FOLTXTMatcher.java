...
public class FOLTXTMatcher {
    ...
    public FOLTXTMatcher() {
        ...
        currTopicID = myRSCManager.getTopicID();
    ...
    // =========================================================================
    // =========================================================================
    // <editor-fold defaultstate="collapsed" desc="populate Topic Anchor OL-SE or BEP O-S">

    public Vector<String[]> populateTopicAnchorOLSE(JTextPane textPane, String topicID) {
        getCurrFullXmlText();
        ...
        // anchorsVbyTopic --> [0]:Offset, [1]:Length, [2]:Anchor_Name, [3]:Status
        Vector<String[]> anchorOLV = myRSCManager.getPoolAnchorsOLNameStatusV();
...
//                log("pureXmlCharUntilOLV: " + pureXmlCharUntilOLV.size());
                String myEntity = "";
                // -------------------------------------------------------------
                int endPoint = i + 10;
                if (pureXmlCharUntilOLV.size() - 1 <= endPoint) {
                    endPoint = pureXmlCharUntilOLV.size() - 1;
                }
                // -------------------------------------------------------------
...
//                    log("myEntity: " + myEntity);
            ...
            if (isSpecial) {
                ...
                boolean notMatched = true;
                while (notMatched) {
//                    if (scrCharCounter <= screenTxtCharV.size() - 1) {
...
//                    }
    ...
    public String getWikiXmlTitleByFilePath(String xmlFilePath) {
        ...
        try {
            ...
            myWikiTitle = xmlFilePath.substring(xmlFilePath.lastIndexOf("\\") + 1, xmlFilePath.lastIndexOf(".xml"));
        }
        return myWikiTitle;
    }
    ...
    public Vector<String[]> getSCRAnchorPosV(JTextPane textPane, String currTopicID, Hashtable<String, Vector<String[]>> topicAnchorsHT) {
        ...
        Vector<String[]> screenAnchorPos = new Vector<String[]>();
        for (String[] thisAnchorSet : anchorOLV) {
            log(thisAnchorSet[0] + " - " + thisAnchorSet[1]);
            String[] scrFOL = screenOffsetLengthFinder(fullScreenText, fullXmlTxt, thisAnchorSet);
            screenAnchorPos.add(scrFOL);
            anchorSetV.add(thisAnchorSet[0] + " : " + thisAnchorSet[1] + " : " + thisAnchorSet[2] + " : " + scrFOL[1] + " : " + scrFOL[2]);
        }
    ...
    public Vector<String[]> getBepSCRSPVS(JTextPane txtPane, String xmlFileID, Vector<String[]> xmlBepOffsetV, boolean isWikipedia) {
        ...
        try {
            ...
            String targetFilePath = "resources\\Temp\\" + xmlFileID + "_pureTxt.txt";
