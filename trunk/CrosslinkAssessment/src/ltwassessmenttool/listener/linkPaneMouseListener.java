    ...
    private void doubleLeftClickEventAction() {
        ...
        if (this.isTAB) {
            ...
            try {
                ...
                String linkBepOffset = this.myFolMatcher.getXmlBepOffset(currALinkID, scrTxtTilStartP);
                // -------------------------------------------------------------
...
//        log("COMPLETION ... ");
        ...
        if (tabCompletedRatio[0].equals(tabCompletedRatio[1]) && tbaCompletedRatio[0].equals(tbaCompletedRatio[1])) {
            ...
            if (this.isTAB) {
                ...
                String bepXmlFilePath = this.myPoolManager.getXmlFilePathByTargetID(nextLinkID);
